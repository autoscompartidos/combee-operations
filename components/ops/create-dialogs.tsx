      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-2">
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="task-title" placeholder="Ej: Diseñar piezas para IG" {...register("title")} />
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-2">
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="camp-name" placeholder="Ej: Lollapalooza 2025" {...register("name")} />
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-2">
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="lead-name" placeholder="Ej: YPF Zona Sur" {...register("partnerName")} />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <Select value={field.value} onValueChange={field.onChange}>
                    <SelectTrigger><SelectValue placeholder="Seleccionar" /></SelectTrigger>
                    <SelectContent>
                      <SelectItem value="Estación de servicio">Estación de servicio</SelectItem>
                      <SelectItem value="Productora">Productora</SelectItem>
                      <SelectItem value="Hostel">Hostel</SelectItem>
                      <SelectItem value="Residencias">Residencias</SelectItem>
                      <SelectItem value="Universidad">Universidad</SelectItem>
                      <SelectItem value="Centro Estudiantil">Centro Estudiantil</SelectItem>
                    </SelectContent>
                  </Select>
                )}
              />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="lead-action" placeholder="Ej: Enviar propuesta" {...register("nextAction")} />
            {errors.nextAction && <p className="text-xs text-destructive">{errors.nextAction.message}</p>}
          </div>
          <div className="flex flex-col gap-1.5">
